...
{    
    ...
    /// 
    /// </summary>    
    public class billDeparture//可以在这里加上基类等
    {
    //将该表下的字段都遍历出来，可以自定义获取数据描述等信息
      ...
      public decimal  ? OilCardDeposit { get; set; }

      public decimal  ? OilCardDepositBalance { get; set; }

      public int  ? OilCardDepositVerifState { get; set; }

      public int  ? SendCount { get; set; }

      public DateTime  ? SJStartTime { get; set; }

      public string  DeliCode { get; set; }

      public string  DepNo { get; set; }

      public string  DepCarNo { get; set; }
      ...
      public string  DriverIDCardNo1 { get; set; }

      public string  DriverPhone2 { get; set; }

      public string  DriverIDCardNo2 { get; set; }

      public string  LongSource { get; set; }

      public string  IsBillStock { get; set; }

      public string  pzglFee { get; set; }

      public string  EmploymentCarID { get; set; }
