...
{    
    ...
    /// 
    /// </summary>    
    public class basMiddle2018//可以在这里加上基类等
    {
    //将该表下的字段都遍历出来，可以自定义获取数据描述等信息
      ...
      public string  MiddleDeliCode { get; set; }

      public string  MiddleCarNo { get; set; }

      public string  MiddleChauffer { get; set; }

      public string  MiddleChaufferPhone { get; set; }

      public decimal  ? MiddleBackFee { get; set; }

      public string  MiddleConfirmMan { get; set; }

      public DateTime  ? MiddleConfirmDate { get; set; }

      public string  MiddleConfirmWeb { get; set; }

      public decimal  ? MiddleFreight { get; set; }

      public decimal  ? MiddleDeliFee { get; set; }

      public decimal  ? MiddleSendFeeLeft { get; set; }
      ...
      public int  ? MiddleAduitState { get; set; }
